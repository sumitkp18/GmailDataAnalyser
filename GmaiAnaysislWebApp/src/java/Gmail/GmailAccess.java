...
public class GmailAccess {
     ...
     */
    private static final java.io.File DATA_STORE_DIR = new java.io.File("D:/");//System.getProperty("user.home"), ".credentials/gmail-java-quickstart.json");
...
//            System.out.println("message id: "+message.getId() +"\nmail body:\n" + filteredData);
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in
                = GmailAccess.class.getResourceAsStream(".\\client_secret.json");
        ...
        GoogleAuthorizationCodeFlow flow
                ...
                .build();
        LocalServerReceiver obj=new LocalServerReceiver();
         browserUrl= "https://accounts.google.com/o/oauth2/auth?access_type=online&client_id=1095155921596-mplfna6f2jisonfas4827ag9nmsd95pa.apps.googleusercontent.com&redirect_uri=http://localhost:"+obj.getPort()+"/Callback&response_type=code&scope=https://www.googleapis.com/auth/gmail.labels%20https://www.googleapis.com/auth/gmail.readonly%20https://www.googleapis.com/auth/gmail.modify";
        
       
         
         
         //Auth class is the user defined version of AuthorizationCodeInstalledApp(Library class)
         Credential credential = new Auth(
                flow, obj).authorize("user");
        System.out.println(
     ...
     */
    public static JSONObject getGmailData() throws IOException, NullPointerException, JSONException {
